  ...
  return (
    <Dialog open={props.open} onClose={props.onClose} fullWidth maxWidth="sm">
                ...
                props.overlays
                  ...
                  .map((overlay) => (
                    <FormControlLabel
                      ...
                      control={
                        <Checkbox
                          checked={props.selectedOverlys.includes(
                            overlay.getId(),
                          )}
              ...
              control={
                <Checkbox
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) =>
                    props.onUpdateUnitsStatusBar(e.target.checked)
                  }
                />
              }
      ...
      <DialogActions>
        ...
        <Button onClick={onSelectAll} disabled={props.overlays.length === 0}>
          Select all
        </Button>
