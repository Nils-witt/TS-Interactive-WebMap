...
import {AppBar, Box, SvgIcon, Tab, Tabs, Toolbar, Typography} from '@mui/material';
    ...
    return (
        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            >
              {NAV_ROUTES.map((r) => (
                <MenuItem key={r.path} onClick={() => {navigate(r.path); handleCloseNavMenu();}}>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            {NAV_ROUTES.map((r) => (
              <Button
                key={r.path}
                onClick={() =>{navigate(r.path);handleCloseNavMenu();}}
