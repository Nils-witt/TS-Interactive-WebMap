...
export function MapUnitContextMenu(props: MapUnitContextMenuProps): JSX.Element {
    const map = useMap();
    ...
    return (
        <>
            ...
            >
                <MenuItem onClick={() => setShowStatusDialog(true)}>Set Status</MenuItem>
                <MenuItem onClick={onSetPosition}>Set Position</MenuItem>
            </Menu>
            <UnitStatusDialog unit={props.unit} open={showStatusDialog} onClose={() => setShowStatusDialog(false)} onSave={onSetStatus} />
        </>
    );
}
