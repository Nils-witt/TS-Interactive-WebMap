...
export function UnitEditDialog(props: UnitEditDialogProps) {
    ...
    const [taktischesZeichen, setTaktischesZeichen] = useState<TaktischesZeichen | null>(null);
    ...
    return (<><Dialog open={props.open} onClose={props.onClose} fullWidth maxWidth="xs">
        ...
        <EditIconDialog open={isIconEdit} entity={props.unit?.getSymbol()} onClose={() => setIsIconEdit(false)} onSave={iconSave}
