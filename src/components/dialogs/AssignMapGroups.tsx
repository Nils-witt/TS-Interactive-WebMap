...
export function AssignMapGroupsDialog(props: AssignMapGroupsDialogProps): JSX.Element {
    ...
    const filteredMapGroups = units.filter((mapGroup) => mapGroup.getName().toLowerCase().includes(nameFilter.toLowerCase()));
                    ...
                    filteredMapGroups.map((mapGroup) => {
                        ...
                        return (
                            <ListItem key={mapGroup.getId()} disablePadding>
                                <ListItemButton onClick={() => toggleAssignedMapGroup(mapGroup.getId())}>
