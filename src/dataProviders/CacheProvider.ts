...
class CacheProvider {
     ...
     * @param tiles
     */
    async cacheVector(vectorLayer: LayerInfo, tiles: { x: number, y: number, z: number }[]): Promise<void> {
     ...
     * @param btn
     */
    async cacheOverlay(overlay: LayerInfo, btn?: HTMLButtonElement): Promise<void> {
