/**
 * NotificationController provides a tiny toast-like notification system.
 * - Singleton access via getInstance()
 * - showNotification(message, priority) to display a temporary banner
 * - setConnectionTest(interval) to periodically ping the backend (basic connectivity check)
 */
...
export class NotificationController {
    ...
    public setConnectionTest(interval: number) {
        setInterval(() => {
